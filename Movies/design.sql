...
CREATE TABLE Tickets (
    ...
    SeatID INT FOREIGN KEY REFERENCES Seats(ID), -- removed ON DELETE CASCADE
...
-- Create stored procedure to delete Tickets by Seat
CREATE PROCEDURE sp_DeleteSeat_Tickets
    @SeatID INT
AS
BEGIN
    DELETE FROM Tickets WHERE SeatID = @SeatID;
END;
GO